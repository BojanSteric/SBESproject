...
namespace Replikator
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            ServiceHost host = new ServiceHost(typeof(ReplikatorService));

            host.AddServiceEndpoint(typeof(IReplikator), binding, adresa);

            host.Open();

            Console.WriteLine("Servis Replikator je pokrenut");
